\resheading{研究经历}
  \begin{itemize}[leftmargin=*]
    \item
      \ressubsingleline{从单目视频中分解、预测动态物体的3D运动并恢复场景深度}{港大硕士毕业论文课题}{2020.02 -- 2021.02}
      {\small
      \begin{itemize}
      \begin{spacing}{1.2}
        \item 在\textbf{\href{https://xjqi.github.io/} {齐晓娟教授}}的指导下，研究并成稿\href{https://qihao-huang.github.io/archive/DO3D_iros2021_manuscript.pdf}
        ...
        % \item 本课题旨在建立\textbf{自监督方式下的动态物体运动预测和深度估计框架}。以往工作的自监督信号仅来源于从邻接帧学习到的相机姿态和场景深度，
